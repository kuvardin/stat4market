...
class CliExitCode
{
    ...
    /**
     * @var string[] a map of reason descriptions for exit codes.
     */
    ...
    public static function getDescription(int $exit_code): ?string
    {
        return self::DESCRIPTIONS[$exit_code] ?? null;
    }
}